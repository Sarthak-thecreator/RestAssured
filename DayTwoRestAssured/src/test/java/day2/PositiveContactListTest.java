...
public class PositiveContactListTest {
  ...
  public void addingContact() {
	  ...
	  details.put("email", "sarthak.dubey1208@gmail.com");
  ...
  public void updatingContact() {
	  ...
	  emp.put("jobTitle", "QA");
	  emp.put("company", "LTI");
	  details.put("firstName", "Avinash");
	  details.put("lastName", "Dubey");
	  details.put("email", "Avinash@gmail.com");
	  details.put("location", loc);
	  details.put("employer", emp);
  ...
  public void deleteSpecificContact3() {
